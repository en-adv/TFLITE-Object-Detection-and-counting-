...
cred = credentials.Certificate("serviceaccount/fixcounter-firebase-adminsdk-l3rrc-dd0766b184.json")  # Update with your service account key
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://fixcounter-default-rtdb.firebaseio.com/'  # Update with your database URL
})
...
while True:
    ...
    for object_name, count in object_counts.items():
        ...
        # Publish object counts to Firebase Realtime Database or Firestore
        ref = db.reference('viewers')
        ref.set(object_counts)  # Set object_counts dictionary as data in Firebase
